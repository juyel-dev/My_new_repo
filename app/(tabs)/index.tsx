...
import { formatTimeAgo } from '@/src/shared/lib/utils';
...
function ConversationRow({
  ...
  return (
    <Animated.View
      entering={Platform.OS !== 'web' ? FadeInDown.delay(index * 40).duration(300) : undefined}
    >
      <Pressable
        onPress={onPress}
        style={({ pressed }) => [
...
export default function ChatsScreen() {
  ...
  }, [haptics, agents, createConversation]);
