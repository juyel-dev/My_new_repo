...
import { MONO_FONT } from '@/src/shared/theme/colors';
...
export function MessageBubble({ message, index, onDelete, onRetry, animated = true }: Props) {
  ...
  const enteringAnimation = animated && Platform.OS !== 'web'
    ? FadeInDown.duration(240).delay(Math.min(index * 30, 150))
    : undefined;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {featureFlags.isEnabled('showModelLabels') && message.model && (
